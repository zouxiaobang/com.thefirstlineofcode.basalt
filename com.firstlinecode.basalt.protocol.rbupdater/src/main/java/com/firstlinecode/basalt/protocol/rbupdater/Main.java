package com.firstlinecode.basalt.protocol.rbupdater;
...
public class Main {
	...
	private void printUsage() {
		...
		System.out.println("java -jar com.firstlinecode.basalt.protocol.rbupdater-${VERSION}.jar BXMPP-FILES START-REPLACEMENT-BYTES.");
	}
}
