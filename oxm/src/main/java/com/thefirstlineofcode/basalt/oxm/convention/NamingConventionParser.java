...
import com.thefirstlineofcode.basalt.oxm.convention.validation.ValidationService;
...
public class NamingConventionParser<T> extends ParserAdaptor<T> {
	...
	private void scanValidationClass() throws InstantiationException, IllegalAccessException {
		...
		validationClass = validationClassType.newInstance();
	...
	private class DefaultPropertyAccessor implements IPropertyAccessor {
		...
		public void write(IParsingContext<?> context, Object object, Object value)
			...
			if ((value instanceof String) && (type != String.class) && isPrimitiveType(type)) {
				try {
