...
import com.thefirstlineofcode.basalt.oxm.convention.annotations.NotBind;
...
import com.thefirstlineofcode.basalt.oxm.convention.conversion.ConversionService;
import com.thefirstlineofcode.basalt.oxm.convention.conversion.Converter;
import com.thefirstlineofcode.basalt.oxm.convention.conversion.ConverterFactory;
...
public class NamingConventionTranslator<T> implements ITranslator<T> {
	...
	public NamingConventionTranslator(Class<T> type) {
		this(getProtocol(type), type);
	}

	private NamingConventionTranslator(Protocol protocol, Class<T> type) {
	...
	private void assembleElementDescriptor(ElementDescriptor descriptor, Field field,
		...
		} else if (isPrimitiveType(field.getType()) || converterAnnotation != null) {
	...
	private void translate(ElementDescriptor descriptor, Object object, IProtocolWriter writer) {
		...
		if (descriptor.text != null) {
			writer.writeText(getValue(descriptor.text.propertyDescriptor, descriptor.text.
